...
export const cities: City[] = [
  ...
  },
  {
    ...
    localParagraph:
      "Enschede heeft een interessante mix van jaren '70-wijken zoals Wesselerbrink en Velve-Lindenhof, en de volledig vernieuwde wijk Roombeek, herbouwd na de vuurwerkramp met moderne, duurzame woningen. De jaren '70-woningen hebben vaak nog originele cv-installaties en wisselende isolatie, waardoor een hybride warmtepomp meestal de beste eerste stap is om te beginnen met besparen. Roombeek is daarentegen gebouwd met oog voor duurzaamheid, en veel woningen daar zijn al geschikt voor een volledig elektrische lucht-water warmtepomp, soms zelfs met stadsverwarming als alternatief. Welk type bij jouw woning past, hangt dus sterk af van de wijk en het bouwjaar. Onze gratis keuzehulp geeft je in een paar minuten een persoonlijke indicatie en koppelt je aan gecertificeerde installateurs in de regio Twente.",
    faqs: [
      {
