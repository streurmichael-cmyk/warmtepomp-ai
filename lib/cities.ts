import { ISDE_HYBRIDE_MAX_TOT } from "./subsidie";
...
export const cities: City[] = [
  ...
  },
  {
    ...
    localFacts: [
      ...
      `ISDE-subsidie voor een hybride warmtepomp: ${ISDE_HYBRIDE_MAX_TOT}, afhankelijk van het vermogen en de SCOP-waarde.`,
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    localFacts: [
      ...
      `ISDE-subsidie voor een hybride warmtepomp in 2026: ${ISDE_HYBRIDE_MAX_TOT}.`,
    ],
    faqs: [
      {
  ...
  },
  {
    ...
    localParagraph:
      "Leiden is een compacte stad met veel kleine, dicht op elkaar gebouwde woningen in de binnenstad en studentenbuurten, en ruimere woningen in naoorlogse wijken als de Merenwijk en Zuidwest. Voor de compacte binnenstadswoningen geldt vaak dat er weinig ruimte is voor een buitenunit, maar moderne warmtepompen zijn inmiddels compact en stil genoeg om ook in zo'n situatie te plaatsen. Door de kleinere oppervlakte is bovendien vaak een warmtepomp met minder vermogen voldoende, wat de kosten drukt. In de Merenwijk en andere jaren '60-70 wijken is de isolatie wisselend, maar met de juiste aanpassingen is een volledig elektrische warmtepomp vaak haalbaar. In wijken als de Stevenshof en Roomburg zie ik in Leiden bovendien veel naoorlogse woningen waar een warmtepomp goed past zodra de isolatie op orde is, en wie in Leiden woont profiteert van de korte lijnen met installateurs in de regio Holland Rijnland. Mijn keuzehulp houdt rekening met de beperkte ruimte die typisch is voor Leidse woningen en helpt je verder richting gecertificeerde installateurs die hier ervaring mee hebben.",
    faqs: [
      {
  ...
  },
  {
    ...
    localParagraph:
      "Enschede heeft een interessante mix van jaren '70-wijken zoals Wesselerbrink en Velve-Lindenhof, en de volledig vernieuwde wijk Roombeek, herbouwd na de vuurwerkramp met moderne, duurzame woningen. De jaren '70-woningen hebben vaak nog originele cv-installaties en wisselende isolatie, waardoor een hybride warmtepomp meestal de beste eerste stap is om te beginnen met besparen. Roombeek is daarentegen gebouwd met oog voor duurzaamheid, en veel woningen daar zijn al geschikt voor een volledig elektrische lucht-water warmtepomp, soms zelfs met stadsverwarming als alternatief. Welk type bij jouw woning past, hangt dus sterk af van de wijk en het bouwjaar. Ook in wijken als Stadsveld en Pathmos zie ik in Enschede oudere woningen waar een hybride warmtepomp de logische start is, terwijl wie in Enschede in Roombeek of nieuwbouw woont vaak meteen volledig elektrisch kan. Mijn gratis keuzehulp geeft je in een paar minuten een persoonlijke indicatie en helpt je verder richting gecertificeerde installateurs in de regio Twente.",
    faqs: [
      {
  ...
  },
  {
    ...
    localParagraph:
      "Apeldoorn heeft veel groene woonwijken met jaren '60-70-woningen, naast de nieuwere wijken Zuidbroek en Het Vlaschveld die de afgelopen jaren zijn ontwikkeld. De oudere woningen hebben vaak een wisselende isolatiegraad: sommige zijn al nageïsoleerd, andere nog niet. Voor woningen die nog niet volledig geïsoleerd zijn, is een hybride warmtepomp de logische eerste stap — hij combineert besparing met een laag instapbedrag. Is jouw woning al voorzien van spouwmuur-, dak- en vloerisolatie? Dan kan een volledig elektrische lucht-water warmtepomp ook al uit. Nieuwbouwwoningen in Zuidbroek en Het Vlaschveld zijn vrijwel altijd al voorbereid op duurzame verwarming. In wijken als De Maten en Zevenhuizen staan in Apeldoorn veel woningen uit de jaren '70 en '80 met een vergelijkbare opzet, waardoor installateurs er snel het juiste vermogen kunnen inschatten. Mijn gratis keuzehulp brengt in kaart wat voor jouw specifieke woning in Apeldoorn het beste past, en helpt je verder richting gecertificeerde installateurs uit de regio.",
    faqs: [
      {
  ...
  },
  {
    ...
    localParagraph:
      "Den Bosch heeft veel naoorlogse wijken met jaren '50-60-woningen, zoals de Kruiskamp, naast nieuwbouw in Boschveld en de groeiwijk De Groote Wielen. De woningen in de Kruiskamp zijn vaak voorzien van originele radiatoren en wisselende spouwmuurisolatie, waardoor een hybride warmtepomp meestal de meest praktische eerste stap is: lage instapkosten en directe besparing op gas, met je cv-ketel als back-up. In Boschveld en De Groote Wielen zijn woningen vaak gebouwd met het oog op duurzaamheid en zijn ze daardoor sneller geschikt voor een volledig elektrische lucht-water warmtepomp. Ook in wijken als de Schutskamp en Hambaken staan in Den Bosch veel naoorlogse woningen waar een hybride warmtepomp de logische eerste stap is. Mijn gratis keuzehulp brengt in kaart welk type warmtepomp het beste past bij jouw specifieke woning in Den Bosch, op basis van bouwjaar, oppervlakte en huidige verwarmingssysteem, en helpt je verder richting gecertificeerde installateurs in de regio.",
    faqs: [
      {
