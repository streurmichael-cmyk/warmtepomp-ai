...
const description =
  "Onafhankelijke keuzehulp voor warmtepompen in Nederland. Persoonlijke indicatie van het beste type warmtepomp, actuele subsidie-informatie en we helpen je verder richting een gecertificeerde installateur.";
