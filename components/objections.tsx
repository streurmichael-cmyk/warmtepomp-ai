...
const objections = [
  {
    ...
    answer:
      "Klopt, de aanschaf is een flinke uitgave: tussen de €7.000 en €14.000, afhankelijk van het type. Met de ISDE-subsidie (tot €3.500) en de besparing op je gasrekening verdien je dat in de meeste gevallen in 7 tot 12 jaar terug. Is je woning slecht geïsoleerd én is je budget krap? Dan is een hybride warmtepomp vaak een betaalbaardere eerste stap dan in één keer volledig overstappen.",
  },
  {
